...
public class TurboSeedanceVideoAutoConfiguration {
    ...
    @Bean
    @ConditionalOnMissingBean
    public TurboSeedanceVideoResourceApiClient turboSeedanceVideoResourceApiClient(
            TurboSeedanceVideoProperties properties,
            ObjectProvider<RestClient.Builder> restClientBuilderProvider
    ) {
        RestClient.Builder builder = restClientBuilderProvider.getIfAvailable(RestClient::builder);
        return new TurboSeedanceVideoResourceApiClient(properties, builder);
    }

    @Bean
    @ConditionalOnMissingBean
    public TurboSeedanceVideoModel turboSeedanceVideoModel(
